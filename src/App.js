...
import AlfareriaIlustration from "./Components/AlfareriaIlustration/AlfareriaIlustration";
import AlfareriaSearch from "./Components/AlfareriaSearch/AlfareriaSearch";
...
import AlfareriaProducts from "./Components/AlfareriaProducts/AlfareriaProducts";
...
function App() {
  ...
  return (
    <>
      ...
      <main className="main">
        <AlfareriaProducts items={items}  newBazar={newBazar}/>
      </main>
    </>
  );
}
